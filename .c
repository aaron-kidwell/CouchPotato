    ...
    /* [in] */ long Flags)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[0],
                  binding_h,
                  hContext,
                  FileName,
                  Flags);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[54],
                  IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[84],
                  IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[114],
                  IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[144],
                  IDL_handle);
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[174],
                  IDL_handle);
    ...
    /* [out] */ long **pUsers)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&efsrpc_StubDesc,
                  (PFORMAT_STRING) &couch_efsr__MIDL_ProcFormatString.Format[204],
                  binding_h,
                  FileName,
                  pUsers);
    return ( long  )_RetVal.Simple;
